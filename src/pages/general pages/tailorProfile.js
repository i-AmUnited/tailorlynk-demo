...
const TailorProfile = () => {
    const img1 = "https://img.freepik.com/free-photo/medium-shot-man-with-braids-portrait_23-2151428195.jpg?t=st=1733173796~exp=1733177396~hmac=74907e16e2b6a58e2fd117c29a8968dd0219e395f7e92b4631f5ccd7494ba313&w=826"  
    ...
    const reviews = [
      {
        ...
        date: "2024-12-01",
        rating: "5.0",
        review: "The service was outstanding from start to finish. Every detail was taken care of, and I couldn't be happier with the results."
      },
      {
        id: 2,
        name: "Jane Smith",
        date: "2024-11-25",
        rating: "4.0",
        review: "The quality of the product was impressive, but the delivery took longer than expected, which was a bit frustrating."
      },
      {
        id: 3,
        name: "Emily Johnson",
        date: "2024-11-20",
        rating: "5.0",
        review: "I had an amazing experience. Everything was seamless, and the team went above and beyond to ensure my satisfaction."
      },
      {
        id: 4,
        name: "Michael Brown",
        date: "2024-11-18",
        rating: "3.0",
        review: "The service was okay, but it didn't meet my expectations. There is definitely room for improvement in some areas."
      },
      {
        id: 5,
        name: "Sarah Davis",
        date: "2024-11-15",
        rating: "4.0",
        review: "The value for money was great. I am pleased with my purchase and would recommend it to others, despite minor flaws."
      },
      {
        id: 6,
        name: "David Wilson",
        date: "2024-11-10",
        rating: "5.0",
        review: "This was truly an exceptional experience. Every aspect exceeded my expectations, and I will definitely be back for more."
      },
      {
        id: 7,
        name: "Laura Martinez",
        date: "2024-11-08",
        rating: "2.0",
        review: "I was quite disappointed with the overall quality. The service did not align with the high standards I had anticipated."
      },
      {
        id: 8,
        name: "James Anderson",
        date: "2024-11-05",
        rating: "4.0",
        review: "The experience was good overall, but there are still areas that could be improved to make it truly exceptional."
      },
      {
        id: 9,
        ...
        date: "2024-11-01",
        rating: "5.0",
        review: "Everything about this was fantastic. From start to finish, I felt valued as a customer, and the results were incredible."
      },
      {
        id: 10,
        name: "Daniel Moore",
        date: "2024-10-30",
        rating: "3.0",
        review: "The product was just okay, but it didn’t live up to the hype. I expected a lot more based on the reviews I had read."
      }
    ];
        ...
        <div className="lg:col-span-3">
          ...
          <div className="bg-white border rounded-md overflow-hidden mb-4">
            ...
            <div className="bg-white p-4 grid gap-6">
              ...
              <Button buttonText={"Report"} otherStyles={"bg-red-500 text-white"}/>
            </div>
          </div>
        </div>
        <Modal modalTitle={"Write a review"} isVisible={reportModal} onClose={() => setReportModal(false)}>
          <SelectInput label={"Overall rating"} options={ratings}/>
          <div className="grid gap-[2px] mt-4">
            <label>Write a review</label>
            <textarea rows={4} placeholder="Start typing..." className="w-full px-4 py-5 md:py-4 border focus:outline focus:outline-primary rounded "/>
          </div>
          <div className="mt-6"><Button buttonText={"Submit review"} otherStyles={"bg-primary text-white"}/></div>
        </Modal>
      </div>
    );
}
