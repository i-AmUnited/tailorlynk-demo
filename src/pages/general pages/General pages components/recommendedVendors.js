    ...
    return ( 
        <div className="grid gap-4">
            ...
            <div className="flex overflow-x-auto lg:grid lg:grid-cols-4 w-full gap-4">
              <ProductCard vendorName={"Silhouette Tailoring"} vendorLocation={"Lagos, Nigeria"}/>
              <ProductCard vendorName={"Sewing by Lola"} vendorLocation={"Ibadan, Nigeria"} />
              <ProductCard vendorName={"Agbada specialist"} vendorLocation={"Ogun, Nigeria"} />
              <ProductCard vendorName={"Sew simple"} vendorLocation={"Lagos, Nigeria"} />
            </div>
        </div>
     );
}
