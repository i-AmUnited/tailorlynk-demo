    ...
    return ( 
        <div className="flex justify-center mb-5">
            <div className="text-center">
                ...
                <div className="secondary-font font-bold text-[15px] mb-2">Payment confirmed!</div>
                <div className="text-xs">Your transaction on TailorLynk has been completed successfully and is now being processed.</div>
                <div className="mt-10">
                  <Button buttonRole={"link"} destination={"/"} buttonText={"Back to home"} otherStyles={"bg-primary text-white"}/>
                </div>
            </div>
        </div>
     );
